...
module Miniprogram
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['MINIPROGRAM_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Miniprogram::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Miniprogram::Action is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-controller#Configuration
      controller.prepare do
        include Miniprogram::Authentication
        # include MyAuthentication # included in all the actions
        # before :authenticate!    # run an authentication before callback
      end

      # Configure the code that will yield each time Miniprogram::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Miniprogram::Assets::Helpers
      end
    end
