...
module MiniprogramAdmin
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['MINIPROGRAM_ADMIN_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load MiniprogramAdmin::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time MiniprogramAdmin::Action is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-controller#Configuration
      controller.prepare do
        include MiniprogramAdmin::Authentication
        # include MyAuthentication # included in all the actions
        # before :authenticate!    # run an authentication before callback
      end

      # Configure the code that will yield each time MiniprogramAdmin::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include MiniprogramAdmin::Assets::Helpers
      end
    end
